...
_Reservation::_Reservation(int s_Day, int s_Month, int s_Year, int s_Minute, int s_Hour,	int e_Day, int e_Month, int e_Year, int e_Minute, int e_Hour) :
	m_StartDateTime{ std::make_shared<DateTime::_DateTime>(s_Day, s_Month, s_Year, s_Minute, s_Hour) },
	m_EndDateTime(std::make_shared<DateTime::_DateTime>(e_Day, e_Month, e_Year, e_Minute, e_Hour)) {}
