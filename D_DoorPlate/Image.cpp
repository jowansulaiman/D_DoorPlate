...
ImageVerarbeitung::Image::Image():m_filename("image.png"), txt(""){  }
ImageVerarbeitung::Image::Image(std::string f):txt(f), m_filename("image.png") {  }
...
void ImageVerarbeitung::Image::readImg()
{
	...
	putText(image, txt, Point(110, 250/*+(i*60)*/), FONT_HERSHEY_DUPLEX, 2, Scalar(0, 0, 0), 2);
}
