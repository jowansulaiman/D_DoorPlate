...
_Reservation::_Reservation(int Day, int Month, int Year, int Sec, int Minute, int Hour) :
	...
	m_End(std::make_shared<DateTime::_DateTime>(Day, Month, Year, Sec, Minute, Hour)), m_ReservationState(NULL) , m_Room(1,"wqe",3){
...
bool _Reservation::is_Reservation_Deleted() {
